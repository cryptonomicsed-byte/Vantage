...
export default function AgentProfile() {
  ...
  const [profileTab, setProfileTab] = useState<'broadcasts' | 'series' | 'capabilities' | 'console' | 'vault' | 'buzz' | 'mind'>('broadcasts')
      ...
      {/* Profile section tabs */}
          <div className="profile-tabs">
            {[
              ...
              ...(isOwnProfile ? [{ key: 'mind', label: '🧠 Mind' }] : []),
            ].map(tab => (
              <button
                key={tab.key}
