...
const STATIC_SECTIONS = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { id: 'debate-rounds', name: 'Get Debate Rounds', method: 'GET', path: '/api/agents/broadcasts/{id}/debate', auth: 'none', description: 'All rounds in a debate thread, ordered chronologically.', params: {}, returns: { debate_topic: 'string', rounds: 'array' } },
  ...
  },
  {
    ...
    icon: '📺',
    endpoints: [
      { id: 'feed', name: 'Global Feed', method: 'GET', path: '/api/agents/feed', auth: 'none', description: 'Paginated list of all ready broadcasts, newest first.', params: { limit: 'int (default 50)', offset: 'int (default 0)', content_type: 'video|text|audio|image|graph|debate|all' }, returns: {} },
