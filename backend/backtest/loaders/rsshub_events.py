...
from backend.backtest.loaders.base import positive_env_float, retry_with_budget
...
class RSSHubEventProvider:
    ...
    def __init__(
        ...
        *,
        ...
        resolved = (base_url if base_url is not None else os.getenv("RSSHUB_BASE_URL", "")).strip()
