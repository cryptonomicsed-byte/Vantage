"""Nostr client for Vantage: NIP-01 events + NIP-42 auth.

Renamed from buzz_client.py. BuzzSession alias kept for backward compat.
"""
import hashlib
import json
import time
...
class NostrSession:
    """Generic NIP-01/NIP-42 WebSocket session to a Nostr relay."""
